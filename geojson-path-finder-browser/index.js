...
// Chad Belisle updated 02.23.20 - changed how roundCoord accessed the features
PathFinder.prototype = {
    findPath: function(a, b) {
        var start = this._keyFn(roundCoord(a.features[0].geometry.coordinates, this._precision)),
            finish = this._keyFn(roundCoord(b.features[0].geometry.coordinates, this._precision));
