...
L.Control.Level = L.Control.extend({
    ...
    onAdd: function(map) {
        ...
        div.style.font = "10px 'Lucida Console',Monaco,monospace";
        ...
        for (i=levels.length-1; i>=0; i--) {
            ...
            // // Chad Belisle update to colours 02.24
            ...
            levelBtn.style.backgroundColor = "#f1b600";
            levelBtn.style.color = "#black";

            if (level === activeLevel || originalLevel === activeLevel) {
                levelBtn.style.backgroundColor = "#911a28";
                levelBtn.style.color = "white";
            }

            // // Chad Belisle updated 02.21
            // // change button text to lower, main and upper for each level
            if (originalLevel == -1) {
                levelBtn.appendChild(levelBtn.ownerDocument.createTextNode("Lower"));}
            
            if (originalLevel == 0 ) {
                levelBtn.appendChild(levelBtn.ownerDocument.createTextNode("Main"));}

            if (originalLevel == 1 ) {
                levelBtn.appendChild(levelBtn.ownerDocument.createTextNode("Upper"));}
    ...
    setLevel: function(level) {
        ...
        if (this._map !== null) {
            if (typeof oldLevel !== "undefined")
                this._buttons[oldLevel].style.backgroundColor = "#f1b600";
                this._buttons[oldLevel].style.color = "black";
            this._buttons[level].style.backgroundColor = "#911a28";
            this._buttons[level].style.color = "white";
        }
